#!/bin/bash
# Initialize test database schema by connecting directly to pernstore_test database

set -e

echo "Initializing pernstore_test database..."

# Connect to pernstore_test and run schema creation
psql -U postgres -d pernstore_test << 'EOF'

-- ══════════════════════════════════════════════════════════════════════════
-- Initialize Test Database Schema (pernstore_test)
-- Connected directly to pernstore_test database
-- ══════════════════════════════════════════════════════════════════════════
...
echo "pernstore_test database initialization complete!"
